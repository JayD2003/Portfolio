  ...
  return (
    <>
        <div className='max-h-full flex justify-start flex-col items-center gap-1 mb-10'>
            <h1 className='text-7xl font-bold font-heading text-copy-primary mb-8'>Skills</h1>
            <div className='grid h-full w-full md:grid-cols-2 lg:grid-cols-3 grid-rows-2 gap-5'>
                <div className='col-span-1 md:col-span-1 lg:col-span-2 border-mainbr border-2 px-5 py-5 rounded-xl shadow-lg shadow-mainbr/20 backdrop-blur-sm'>
                ...
                <div className='col-span-1 border-mainbr border-2 px-5 py-5 rounded-xl shadow-lg shadow-mainbr/20 backdrop-blur-sm'>
                    <div className="text-left gap-2 flex flex-col">
                        <div className='flex flex-row justify-start items-center gap-2'>
                ...
                <div className='col-span-1 md:col-span-1 lg:col-span-1 border-mainbr border-2 px-5 py-5 rounded-xl shadow-lg shadow-mainbr/20 backdrop-blur-sm'>
                <div className="text-left gap-2 flex flex-col">
